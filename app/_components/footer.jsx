...
const ContactIcon = ({ icon, texts = [] }) => {
	return (
		<div className='flex flex-col items-center justify-center w-full mb-[20px]'>
			...
			<span className='text-center text-[18px] font-[600]'>{texts[0]}</span>
		...
		<section className='xss:px-[10px] sm:px-[40px] md:px-[80px] pt-[20px] w-full'>
			<div
				...
				<div className='col-span-1 flex flex-col items-center justify-start'>
					<div>
						Etiam egestas viverra odio, id egestas odio pharetra nec. Nunc a aliquam risus, eget laoreet diam. Etiam quis venenatis
						lectus.
					</div>
					<CustomButton
					...
					<div className='w-full flex xss:justify-center sm:justify-start mb-[15px] font-[500]'>Connect with us @</div>
